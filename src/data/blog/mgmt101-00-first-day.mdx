...
<Summary>
  ...
  <ol>
    ...
    <li>Effective Communication Strategies for New Managers</li>
    <li>Setting Goals and Expectations for Your Team</li>
    <li>Providing Feedback and Recognition: The Keys to Employee Growth and Engagement</li>
    <li>Managing Conflict in the Workplace: Strategies for Resolution and Growth</li>
    <li>Developing Your Leadership Style: Finding Your Path as a Manager</li>
    <li>Building High-Performing Teams: Strategies for Success</li>
    <li>Managing Up: How to Build a Strong Relationship with Your Own Manager</li>
    <li>Creating a Culture of Learning and Development in Your Team</li>
  </ol>
  </Indent>
</Summary>
