...
<article>
<h2>4. Sapiens: A brief history of mankind</h2>
...
<br />
  ...
  <div class="markdown-grid-content-description-layout">
    ...
    <div>
      <p>
        This book is a great read. It is a history of mankind from the author's perspective, Yuval Noah Harari. <br/><br/>The best thing about it is its theories that get you to think about the world differently. They are not necessarily new or supported by evidence but interesting and thought-provoking.
      </p>
    </div>
  </div>
  <div class="markdown-spacer-small"></div>
...
<article>
<h2>5. Why We Sleep by Matthew Walker</h2>
...
<div class="markdown-grid-content-description-layout">
    ...
    <div>
      <p>
        Why we sleep is a great book that explains the importance of sleep and how it affects our health and well-being.
        <br /><br />
        The conclusions are not surprising... or they shouldn't be. But to learn about why from someone who has spent his life studying sleep with a scientific perspective can not be understated.
      </p>
    </div>
  </div>
  <div class="markdown-spacer-small"></div>
...
<article>
<h2>6. Purple Hibiscus by Chimamanda Ngozi Adichie</h2>
